...
<head>
<title>Descàrregues IDEBarcelona - No s'ha pogut generar fitxer</title>
...
<p>La vostra descàrrega no s'ha pogut generar per un error.</p>
${superatMida}
<p>Si us plau, torneu-ho a provar d'aquí a una estona. Si el problema persisteix, contacteu amb el nostre suport tècnic a sitmun@diba.cat.</p> 
	</td>
