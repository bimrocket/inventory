...
public enum RhinoTransformerConfigKeys {
	...
	TRANSFORMER_JSON_PATH_LOCAL_ID("json.path.local.id", "JSON Path to local_id used for global id creation", true),
	...
	TRANSFORMER_SCRIPT_SCOPE_GLOBAL_ID_NAME("scope.global.id.name", "Name of globalId variable inside javascript, should be singular name", true),
