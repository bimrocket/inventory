...
<head>
<title>Descargas IDEBarcelona - Archivo con errores</title>
...
<img src="${imgUrl}logo-diba.png" alt="DIBA - Descàrregues IDE"
style="display: block;" />
	</td>
</tr>
<tr>
	<td align="center" style="padding: 40px 30px 40px 30px;">
<p>Apreciado/da ${name},</p>
<p>Tu descarga ya está preparada aunque han habido errores generando algunos de los ficheros solicitados.</p>
${superatMida}
<p>Puedes descargar los archivos que hemos podido generar haciendo clic en el siguiente botón:</p> 
<a href="${download_url}" target="_blank" class="activate">DESCARGAR</a>
<p id="pUrlNavegador" style="width: 600px; word-wrap: break-word; font-family: 'Montserrat', Arial, sans-serif; color: #c3c3c3; font-size: 13px; font-weight: bold; line-height: 1.5em; margin: 10px;">
                	¿No funciona el botón? Copia y pega el siguiente enlace en tu navegador<br />
