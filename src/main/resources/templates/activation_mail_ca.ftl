...
<head>
<title>Descàrregues IDEBarcelona - Activació de l'usuari</title>
...
<p>Benvingut/da ${name},</p>
<p>Utilitzeu la següent clau per registrar-vos al servei amb el vostre email:</p>
<p class="activate">${code}</p>
	</td>
</tr>
<tr>
