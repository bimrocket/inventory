...
export class DialogConsultaDGTComponent implements OnInit {
  ...
  constructor(
    ...
    private vehicleService: VehicleService, private auth: AuthorizationService, private fileService: FileService, 
    private thisDialogRef: MatDialogRef<DialogConsultaDGTComponent>, @Inject(MAT_DIALOG_DATA) public data: any) { }
