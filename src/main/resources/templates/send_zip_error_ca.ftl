...
<head>
<title>Descàrregues IDEBarcelona - Fitxer amb errors</title>
...
<p>La vostra descàrrega ja està preparada, tot i que hi ha hagut errors generant alguns dels fitxers demanats.</p>
${superatMida}
<p>Podeu descarregar els fitxers que hem pogut generar fent clic al següent botó:</p> 
<a href="${download_url}" target="_blank" class="activate">DESCARREGAR</a>
<p id="pUrlNavegador" style="width: 600px; word-wrap: break-word; font-family: 'Montserrat', Arial, sans-serif; color: #c3c3c3; font-size: 13px; font-weight: bold; line-height: 1.5em; margin: 10px;">
                	No funciona el botó? Copieu i enganxeu el següent enllaç al vostre navegador<br />
