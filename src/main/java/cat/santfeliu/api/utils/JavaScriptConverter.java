...
public class JavaScriptConverter extends ObjectConverter {
	...
	public JavaScriptConverter(ConfigContainer config) {
		super(config);
	...
	public void begin(Map<String, String> scopeObjects) throws Exception {
		...
		String source = this.config.getParamValue(RhinoTransformerConfigKeys.TRANSFORMER_JAVASCRIPT_SCRIPT.getKey());
