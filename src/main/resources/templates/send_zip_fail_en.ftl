...
<head>
<title>Downloads IDEBarcelona - Couldn't generate file</title>
...
<p>Dear ${name},</p>
<p>Your download couldn't be generated due to internal errors.</p>
${superatMida}
<p>Please try again after some time, if problem persists contact our technical support at sitmun@diba.cat.</p> 
	</td>
